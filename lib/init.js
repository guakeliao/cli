...
// async function initProject(projectName) {    try {
...
//     } else {
//         // 执行控制台交互
//         inquirer                .prompt([                    {                        type: 'input', // 类型，其他类型看官方文档
...
//             // 开始执行等待动画
//             initSpinner.start()                                        // 拼接 template 文件夹路径
//             const templatePath = path.resolve(__dirname, '../template/')
//             // 返回 Node.js 进程的当前工作目录
//             const processPath = process.cwd()                    // 把项目名转小写
//             const LCProjectName = projectName.toLowerCase()                    // 拼接项目完整路径
...
//                 process.exit()                    }                                        // 把要替换的模板字符准备好
//             const multiMeta = {                      project_name: LCProjectName,                      global_name: answers.name                    }                    // 把要替换的文件准备好
...
//                     // 终止等待动画并显示 X 标志
//                     initSpinner.fail()                            // 退出进程
//                     process.exit()                        }                    }                                        // 如果成功，Spinner 就改变文字信息
//             initSpinner.text = 'Initialize project successful.'
//             // 终止等待动画并显示 ✔ 标志
//             initSpinner.succeed()                    console.log(`
// To get started:
...
//             }                })        }    } catch (err) {
//     console.error(err)
//     process.exit()    }}// 将上面的 initProject(projectName) 方法导出
